#!/usr/bin/env python
"""
Test script for verifying the translation functionality with exact model parameters.
"""
...
def test_translation():
    """Test basic translation functionality with exact parameters matching the saved model."""
    # Parameters from the saved model inspection
    model_path = "models/model_attn_final.pt"
    src_tokenizer_path = "en_tokenizer.json"
    tgt_tokenizer_path = "fr_tokenizer.json"
    use_attention = True
    hidden_dim = 64    # From model inspection
    emb_dim = 32       # From model inspection
    n_layers = 1       # From model inspection
    src_vocab_size = 100  # From model inspection
    tgt_vocab_size = 100  # From model inspection
