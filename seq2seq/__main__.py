...
def main():
    ...
    train_parser = subparsers.add_parser(
        "train", help="Train a sequence-to-sequence model"
    )
    train_parser.add_argument(
        "--src_lang", type=str, default="en", help="Source language"
    )
    train_parser.add_argument(
        "--tgt_lang", type=str, default="fr", help="Target language"
    )
    train_parser.add_argument("--batch_size", type=int, default=32, help="Batch size")
    train_parser.add_argument(
        "--max_length", type=int, default=100, help="Maximum sequence length"
    )
    train_parser.add_argument(
    ...
    train_parser.add_argument(
        "--tf_ratio", type=float, default=0.5, help="Teacher forcing ratio"
    )
